...
use ModulesGarden\PlanetHoster\Core\UI\Widget\Forms\BaseForm;
use ModulesGarden\PlanetHoster\Core\UI\Widget\Forms\Fields\ColorPicker;
use ModulesGarden\PlanetHoster\Core\UI\Widget\Forms\Fields\Hidden;
use ModulesGarden\PlanetHoster\Core\UI\Widget\Forms\Fields\Number;
use ModulesGarden\PlanetHoster\Core\UI\Widget\Forms\Fields\Select2vueByValueOnly;
use ModulesGarden\PlanetHoster\Core\UI\Widget\Forms\FormConstants;
use ModulesGarden\PlanetHoster\Core\UI\Widget\Graphs\EmptyGraph;
use function ModulesGarden\PlanetHoster\Core\Helper\sl;
use function ModulesGarden\PlanetHoster\Core\request;
...
class SettingForm extends BaseForm
{
    ...
    protected $providerClass = 'ModulesGarden\PlanetHoster\Core\UI\Widget\Graphs\Settings\SettingDataProvider';
