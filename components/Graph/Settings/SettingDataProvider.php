...
use ModulesGarden\PlanetHoster\Core\Models\ModuleSettings\ModuleSettings;
use ModulesGarden\PlanetHoster\Core\Support\Facades\Request;
use ModulesGarden\PlanetHoster\Core\UI\Widget\Forms\DataProviders\BaseModelDataProvider;
...
class SettingDataProvider extends BaseModelDataProvider
{
    ...
    {
        parent::__construct('\ModulesGarden\PlanetHoster\Core\Models\ModuleSettings\ModuleSettings');
    }
