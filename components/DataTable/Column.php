...
use ModulesGarden\PlanetHoster\Core\Data\ToArrayTrait;
use ModulesGarden\PlanetHoster\Core\DataProviders\AbstractRecordsListDataProvider;

class Column extends \ModulesGarden\PlanetHoster\Core\DataProviders\Column implements \JsonSerializable
{
    use ToArrayTrait;
