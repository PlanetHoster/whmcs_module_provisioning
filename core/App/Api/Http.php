...
namespace ModulesGarden\PlanetHoster\Core\Api;

use AltoRouter;
use Exception;
use ModulesGarden\PlanetHoster\App\Libs\Exceptions\ApiException;
use ModulesGarden\PlanetHoster\App\Libs\Exceptions\WhmcsApiException;
use ModulesGarden\PlanetHoster\Core\ModuleConstants;
use ModulesGarden\PlanetHoster\Core\Traits\IsDebugOn;
...
class Http
{
    ...
    {
        $classname = "\\ModulesGarden\\PlanetHoster\\App\\Http\\Api\\{$classname}";
