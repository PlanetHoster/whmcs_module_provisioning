...
class CustomField extends \WHMCS\CustomField
{
    ...
    {
        return $this->hasOne("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Product", "id", "relid");
    }

    public function addon()
    {
        return $this->hasOne("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Addon", "id", "relid");
    }

    public function customFieldValues()
    {
        return $this->hasMany("ModulesGarden\PlanetHoster\Core\WHMCS\Models\CustomFieldValue", "fieldid");
    }
