...
class TldCategoryPivot extends EloquentModel
{
    ...
    {
        return $this->hasOne('ModulesGarden\PlanetHoster\Core\WHMCS\Models\TldCategory', 'tld_id');
    }

    public function tld()
    {
        return $this->hasOne('ModulesGarden\PlanetHoster\Core\WHMCS\Models\Tld', 'tld_id');
    }
}
