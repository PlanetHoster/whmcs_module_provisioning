...
class ProductUpgrade extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Product", 'upgrade_product_id');
    }

    public function product()
    {
        return $this->belongsTo("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Product", 'product_id');
    }
}
