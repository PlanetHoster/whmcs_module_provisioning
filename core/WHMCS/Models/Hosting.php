...
class Hosting extends EloquentModel
{
    ...
    {
        return $this->hasMany("ModulesGarden\PlanetHoster\Core\WHMCS\Models\HostingAddon", 'hostingid');
    }
    ...
    {
        return $this->hasMany("ModulesGarden\PlanetHoster\Core\WHMCS\Models\HostingConfigOption", 'relid');
    }
