...
class Upgrade extends \WHMCS\Service\Upgrade\Upgrade
{
    ...
    public function hosting()
    {
        ...
        return $this->belongsTo("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Hosting", 'relid');
    }
    ...
    {
        return $this->hasOne("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Product", "id", "originalvalue");
    }

    public function newProduct()
    {
        return $this->hasOne("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Product", "id", "newvalue");
    }

    public function originalAddon()
    {
        return $this->hasOne("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Addon", "id", "originalvalue");
    }
    public function newAddon()
    {
        return $this->hasOne("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Addon", "id", "newvalue");
    }
    ...
    public function productFrom()
    {
        ...
        return $this->belongsTo("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Product", 'originalvalue');
    }
}
