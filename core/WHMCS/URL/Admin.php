...
class Admin
{
    public static function adminSummary(int $adminId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('configadmins.php', $parameters);
    }
    ...
    public static function clientSummary(int $clientId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('clientssummary.php', $parameters);
    }
    ...
    public static function clientServices(int $clientId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('clientsservices.php', $parameters);
    }
    ...
    public static function clientDomains(int $clientId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('clientsdomains.php', $parameters);
    }
    ...
    public static function invoices(int $invoiceId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('invoices.php', $parameters);
    }
    ...
    public static function tickets(int $ticketId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('supporttickets.php', $parameters);
    }
    ...
    public static function orders(int $orderId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('orders.php', $parameters);
    }
    ...
    public static function productConfig(int $productId, array $parameters = [])
    {
        ...
        return \ModulesGarden\PlanetHoster\Core\Routing\Url::adminarea('configproducts.php', $parameters);
    }
}