...
namespace ModulesGarden\PlanetHoster\Core\DependencyInjection;

use ModulesGarden\PlanetHoster\Core\ModuleConstants;
use ModulesGarden\PlanetHoster\Core\Packages\Config;
use ModulesGarden\PlanetHoster\Core\Packages\Packages;
...
class PackageServices
{
    ...
    protected function getEnabledPackages(): array
    {
        ...
        {
            if (\ModulesGarden\PlanetHoster\Core\Support\Facades\Config::get('packages.' . $package, false))
            {
    ...
    protected function registerConfig(Config $config, $package)
    {
        ...
        {
            \ModulesGarden\PlanetHoster\Core\Support\Facades\Config::push('install.' . lcfirst($package), $config->get('config'));
        }
    }
