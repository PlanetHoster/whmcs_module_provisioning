...
class Addon extends \WHMCS\Product\Addon
{
    ...
    {
        return $this->hasMany("ModulesGarden\PlanetHoster\Core\WHMCS\Models\CustomField", "relid")->where("type", "=", "addon")->orderBy("sortorder");
    }

    public function serviceAddons()
    {
        return $this->hasMany("ModulesGarden\PlanetHoster\Core\WHMCS\Models\ServiceAddon", "addonid");
    }
}
