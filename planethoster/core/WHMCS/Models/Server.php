...
class Server extends \WHMCS\Product\Server
{
    ...
    {
        return $this->hasMany("ModulesGarden\PlanetHoster\Core\WHMCS\Models\Service", "server");
    }

    public function addons()
    {
        return $this->hasMany("ModulesGarden\PlanetHoster\Core\WHMCS\Models\ServiceAddon", "server");
    }
