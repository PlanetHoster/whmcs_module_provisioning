...
class PhpMyAdminForm extends Form implements AjaxComponentInterface, ClientAreaInterface
{
    protected string $provider = DatabaseAccountProvider::class;
    protected string $providerAction = DatabaseAccountProvider::PHP_MY_ADMIN;
