...
use ModulesGarden\PlanetHoster\App\UI\Client\Shared\AccountDetails\Forms\DeleteEmailAccountForm;
...
class DeleteEmailAccountModal extends ModalDanger implements AjaxComponentInterface, ClientAreaInterface
{
    public function loadHtml(): void
    {
        $this->setTitle($this->translate('title'));
        $this->setContent($this->translate('deleteProduct'));
        $this->addElement(new DeleteEmailAccountForm());
    }
}
