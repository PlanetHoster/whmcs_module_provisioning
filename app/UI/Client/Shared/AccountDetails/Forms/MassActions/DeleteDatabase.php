...
class DeleteDatabase extends AbstractForm implements ClientAreaInterface, AjaxComponentInterface
{

    protected string $provider = Providers\DatabaseAccountProvider::class;
    protected string $providerAction = Providers\DatabaseAccountProvider::ACTION_MASS_DELETE;
