...
class DeleteFtp extends AbstractForm implements ClientAreaInterface, AjaxComponentInterface
{

    protected string $provider = Providers\FtpAccountsProvider::class;
    protected string $providerAction = Providers\FtpAccountsProvider::ACTION_MASS_DELETE;
